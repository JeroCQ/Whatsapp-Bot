...
| Contactos sin catálogo | 121: 107 ligados a falta de créditos y 14 por otras causas |
...
| Handoffs operativos, excluyendo falta de créditos | 44 eventos / 44 contactos |
| Conversaciones resueltas | 122; ninguna tenía resultado comercial estructurado |
| Contactos que volvieron después de `RESOLVED` | 10; 0 ventas demostrables y 10 resultados desconocidos |
| Respuesta del bot | mediana 4,2 s; p90 10,6 s |
| Handoff operativo hasta respuesta humana | mediana 41,5 min; p90 687,6 min |
| Handoffs operativos atendidos antes de 1 hora | 62,8% |
...
## Por qué 121 leads no recibieron el catálogo

- **107 de los 121 casos (88,4%)** coinciden con conversaciones afectadas por falta de créditos. El turno terminó en fallback/handoff antes de que Gemini solicitara el archivo.
- En los **14 casos restantes**, siete muestran mensajes de fallback sin la razón estructurada de créditos; seis eran saludos o consultas solo de ubicación, que la instrucción anterior no obligaba a acompañar con catálogo; y uno fue incumplimiento del modelo ante una consulta explícita de producto.
...
El archivo contiene 122 cierres. Solo 10 contactos volvieron a escribir después; en ninguno aparece evidencia suficiente de venta cerrada ni de venta perdida, por lo que los 10 quedan como **resultado desconocido**. Esto demuestra que `RESOLVED` solo significa “ticket cerrado”, no “venta cerrada”. El analizador separa ahora `sold`, `not_sold` y `unknown` tanto en el intervalo cerrado como en la actividad posterior. Para eliminar los desconocidos se debe registrar un estado comercial obligatorio al resolver.
