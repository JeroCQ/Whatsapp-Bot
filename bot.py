...
IMPORTANTE: Evalúa estas reglas usando el mensaje del turno actual. Una solicitud de asesor, queja o causal de escalamiento que aparezca solamente en el historial es contexto pasado y NO debe volver a activar el handoff.
